...
class BasicOverView {
  ...
  factory BasicOverView.fromJson(Map<String, dynamic> json) => BasicOverView(
        ...
        interested: List<Going>.from(json["interested"].map((x) => Going.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "interested": List<dynamic>.from(interested??[].map((x) => x.toJson())),
        "meta": meta?.toJson(),
      };
}
