...
class KConversationLoadingIndicator extends StatelessWidget {
  final int feedItemCount;

  const KConversationLoadingIndicator({this.feedItemCount = 7, Key? key}) : super(key: key);
                              ...
                              Container(
                                ...
                                child: Shimmer.fromColors(
                                  ...
                                  child: SizedBox(
                                    width: 50,
                                    height: 12,
                                    child: Container(color: AppMode.darkMode ? KColor.grey850const : KColor.grey100const),
                                  ),
                                ),
                              ),
                            ],
