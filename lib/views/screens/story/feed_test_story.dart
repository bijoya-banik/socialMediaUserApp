...
class StoryTestScreen extends StatefulWidget {
  final List<Story>? stories;
   ...
   const StoryTestScreen({Key? key, @required this.stories}) : super(key: key);

  @override
  _StoryTestScreenState createState() => _StoryTestScreenState();
}

class _StoryTestScreenState extends State<StoryTestScreen> with SingleTickerProviderStateMixin {
