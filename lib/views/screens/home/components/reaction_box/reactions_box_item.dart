...
typedef OnReactionClick = void Function(ReactionModel?);
...
class _ReactionsBoxItemState extends State<ReactionsBoxItem> with TickerProviderStateMixin {
  ...
  bool _isWidgetHovered(DragData? dragData) {
    ...
    return (widgetRect?.contains(dragData!.offset) ?? false) ||
        (widgetRect?.shift(Offset(0, _widgetSize!.height)).contains(dragData!.offset) ?? false) ||
        (widgetRect?.shift(Offset(0, -_widgetSize!.height)).contains(dragData!.offset) ?? false);
  }
              ...
              builder: (_, child) {
                return Transform.scale(
                  ...
                  child: AnimatedContainer(
                    width: _widgetSize != null ? _widgetSize!.width * _scaleAnimation.value : null,
