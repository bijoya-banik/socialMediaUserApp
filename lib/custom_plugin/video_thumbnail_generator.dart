      ...
      builder: (BuildContext context, AsyncSnapshot snapshot) {
        switch (snapshot.connectionState) {
          ...
          case ConnectionState.waiting:
            return Center(
              child: SizedBox(
                  height: KSize.getHeight(context, height), width: KSize.getHeight(context, width), child: const CupertinoActivityIndicator()),
            );
                  ...
                  child: Stack(
                    children: [
                      ...
                      Positioned(
                        child: Center(
                          child: Container(
                            margin: EdgeInsets.only(top: KSize.getHeight(context, 70)),
                            height: 45,
                            width: 45,
                            decoration: BoxDecoration(shape: BoxShape.circle, color: KColor.white.withOpacity(0.6)),
                            child: Icon(Icons.play_arrow, size: 30, color: KColor.blue),
                          ),
                        ),
                      ),
                    ],
                ...
                children: [
                  ...
                  type == "replySwipe"
                      ...
                      : Positioned(
                          child: Center(
                            child: Container(
                              margin: EdgeInsets.only(top: KSize.getHeight(context, type == "reply" || type == "story" ? 0 : 70)),
                              height: 45,
                              width: 45,
                              decoration: BoxDecoration(
                                  shape: BoxShape.circle, color: AppMode.darkMode ? KColor.black.withOpacity(0.4) : KColor.white.withOpacity(0.6)),
                              child: Icon(Icons.play_arrow, size: 30, color: KColor.black87),
                            ),
                          ),
                        ),
                ],
