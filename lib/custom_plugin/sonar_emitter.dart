...
//     this.contentAreaColor = const Color(0xFFF0F2F5),
//     // this.innerWaveColor = const Color(0xFFF0F2F5),
//     this.outerWaveColor = const Color(0xFFF0F2F5),
//     this.child,
//   });
...
//           contentAreaColor: widget.contentAreaColor,
...
class ColorSonar extends StatefulWidget {
  ...
  const ColorSonar({Key? key, 
    ...
    this.duration = const Duration(seconds: 1),
    this.wavesDisabled = false,
    this.contentAreaColor = Colors.transparent,
